 ...
 function (e, t, i) {
			...
			value: function () {
				...
				this.$el.find(this.settings.tabSelector).each(function () {
					...
					var s = [];
					 ...
					 $fields.each(function () {
						t = $(this), i = parseInt(t.data("id")), t.data("_conditionsBuilder") ? t.data("_conditionsBuilder").update({
							toggleFields: s
						}) : t.data("_conditionsBuilder", new a({
							fieldId: i,
							toggleFields: s,
						...
						if (e ? (r[i] = e, t.addClass("conditionsHasConditionals")) : t.removeClass("conditionsHasConditionals"), !t.data("_conditionsSettingsMenuItemInitialized")) {
							...
							d.find("ul").children(":first").clone(!0).insertBefore(d.find("ul:first li:last")).find("a:first").data("_conditionsField", t).attr("data-action", "toggle-conditionals").html("Edit conditionals"), t.data("_conditionsSettingsMenuItemInitialized", !0);
	...
	var i = Garnish.Base.extend({
		...
		init: function (e) {
			...
			this.$container.on("click", ".conditionsAddRule", $.proxy(this.onConditionsAddRuleClick, this))
		...
		refresh: function () {
			...
			d.each(function () {
				return t = [], i = $(this), s = i.find(".conditionsRule"), s.each(function () {
					n = $(this);
		...
		defaults: {
			...
			selectColumns : function(options,isMultiSelect)
            {
				...
				*/
				...
				builderUi: function () {
					return  '<div class="conditionsBuilderUi">' +
                            '<div class="wrapper">' +
	...
	e.exports = function () {
		...
		*/
		...
		function e(t, s) {
			...
			}, this.$el = t, this.id = this.$el.attr("id"), this.id || (this.id = "_conditionsForm-" + Math.random().toString(36).slice(2), this.$el.attr("id", this.id)), this.conditionals = s, $(this.init.bind(this)), this
		}
		return s(e, [{
			key: "init",
			value: function () {
		//	alert('aaaaa');
			...
			value: function () {
				...
				for (var e, t = this, i = ["elementselect", "categoriesfield"], s = 0; s < i.length; ++s) $(this.settings.fieldsSelector + " ." + i[s]).each(function () {
					if (!$(this).hasAttr("data-conditionselementselect")) {
						var i = (new Date).getTime(),
							s = function () {
								e = $(this).data("elementSelect"), e ? (e.on("selectElements", t.onElementSelectChange.bind(t)), e.on("removeElements", t.onElementSelectChange.bind(t)), $(this).attr("data-conditionselementselect", ""), t.onElementSelectChange()) : (new Date).getTime() - i < 2e3 && Garnish.requestAnimationFrame(s)
							}.bind(this);
						s()
					}
				})
			...
			value: function () {
				...
				$("[data-conditionselementselect]").each(function () {
					e = $(this).data("elementSelect"), e && (e.off("selectElements", t.onElementSelectChange.bind(t)), e.off("removeElements", t.onElementSelectChange.bind(t))), $(this).removeAttr("[data-conditionselementselect]")
				})
			}
		}, {
			...
			value: function () {
				...
				u.removeClass("conditionsHide").removeAttr("aria-hidden").removeAttr("tabindex").each(function () {
					e = $(this);
					...
					if ( t) {
						...
						console.log(h);
						console.log(e);
						h <= 0 && e.addClass("conditionsHide").attr("aria-hidden", "true").attr("tabindex", "-1")
					}
				})
			}
		}, {
