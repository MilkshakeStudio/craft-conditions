...
class Install extends Migration
{
    ...
    // conditions_conditionalsrecord table
        $this->addForeignKey(
            $this->db->getForeignKeyName('{{%conditions_conditionalsrecord}}', 'siteId'),
            '{{%conditions_conditionalsrecord}}',
            'siteId',
            '{{%sites}}',
            'id',
    ...
    {
    // conditions_conditionalsrecord table
        $this->dropTableIfExists('{{%conditions_conditionalsrecord}}');
    }
}
